...
val drinksMakeYouDizzy = FoodTagPunishment.levelBased(
    ...
    MobEffects.CONFUSION, 10 * FoodTalks.TPS, 0
...
val drugsPoisonYou = FoodTagPunishment.levelBased(
    ...
    MobEffects.POISON, 10 * FoodTalks.TPS, 0
